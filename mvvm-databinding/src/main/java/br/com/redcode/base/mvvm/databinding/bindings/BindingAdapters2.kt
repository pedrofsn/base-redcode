...
import br.com.redcode.base.mvvm.databinding.bindings.BindingAdapters.changeBackground
...
// -------------------------------------------------------------------------------------------------> TextView
    ...
    @JvmStatic
    @BindingAdapter(
        value = ["app:changeColorFrom", "app:changeColorTo", "app:case"],
        requireAll = true
    )
